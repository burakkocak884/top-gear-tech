...
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 1)
Appointment.create(type: "Brakes", description: "New Front Brakes", total_cost: 350, vehicle_id: 2)
Appointment.create(type: "Premium Oil Change", description: "5W-20 Oil and oil filter", total_cost: 35, vehicle_id: 3)
Appointment.create(type: "Air Condition", description: "Recharge", total_cost: 60, vehicle_id: 4)
Appointment.create(type: "Premium Oil Change", description: "5W-30 Oil and oil filter", total_cost: 35, vehicle_id: 5)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 6)
Appointment.create(type: "Brakes", description: "New rear pads", total_cost: 150, vehicle_id: 7)
Appointment.create(type: "Shocks", description: "rear shocks", total_cost: 150, vehicle_id: 8)
Appointment.create(type: "Premium Oil Change", description: "oild filter and 10w-40 oil", total_cost: 150, vehicle_id: 9)
Appointment.create(type: "Air Condition", description: "Leak repair", total_cost: 250, vehicle_id: 10)
Appointment.create(type: "Premium Oil Change", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 11)
Appointment.create(type: "Brakes", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 12)
Appointment.create(type: "Premium Oil Change", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 12)
Appointment.create(type: "Air Condition", description: "new Compressor", total_cost: 150, vehicle_id: 13)
Appointment.create(type: "Brakes", description: "Re-adjusted", total_cost: 0, vehicle_id: 14)
Appointment.create(type: "Air Condition", description: "flush only", total_cost: 150, vehicle_id: 15)
Appointment.create(type: "Premium Oil Change", description: "oil and oil filter", total_cost: 35, vehicle_id: 16)
Appointment.create(type: "Premium Oil Change", description: "full-syn 0w40 oil and oil filter", total_cost: 150, vehicle_id: 17)
Appointment.create(type: "Brakes", description: "cleaned", total_cost: 150, vehicle_id: 18)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 19)
Appointment.create(type: "Air Condition", description: "recharge", total_cost: 150, vehicle_id: 20)
Appointment.create(type: "Brakes", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 21)
Appointment.create(type: "Premium Oil Change", description: "new oil filter", total_cost: 150, vehicle_id: 22)
Appointment.create(type: "Premium Oil Change", description: "Oil and oil filter", total_cost: 150, vehicle_id: 22)
Appointment.create(type: "Air Condition,Premium Oil Change", description: "Drain, flush, refill, and 10w-30 oil w/filter", total_cost: 150, vehicle_id: 22)
Appointment.create(type: "Transmission fluid Change", description: "Drain, flush, refill", total_cost: 300, vehicle_id: 21)
Appointment.create(type: "Brakes", description: "rear rotors and pads", total_cost: 250, vehicle_id: 13)
Appointment.create(type: "Air Condition", description: "front pads", total_cost: 125, vehicle_id: 12)
Appointment.create(type: "Brakes", description: "cleaned", total_cost: 75, vehicle_id: 14)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 11)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 9)
Appointment.create(type: "Shocks", description: "new rear and front shocks", total_cost: 850, vehicle_id: 10)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 8)
Appointment.create(type: "Air Condition", description: "recharge", total_cost: 150, vehicle_id: 6)
Appointment.create(type: "Air Condition,Premium Oil Change", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 5)
Appointment.create(type: "Filter, Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 4)
Appointment.create(type: "Brakes, Air Condition,Premium Oil Change", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 3)
Appointment.create(type: "Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 8)
Appointment.create(type: "Shocks", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 1)
Appointment.create(type: "Brakes, Air Condition", description: "Drain, flush, refill", total_cost: 150, vehicle_id: 9)
Appointment.create(type: "Air Condition", description: "recharge", total_cost: 150, vehicle_id: 4)
Appointment.create(type: "Shocks", description: "new front shocks", total_cost: 550, vehicle_id: 9)
Appointment.create(type: "Air Condition,Shocks", description: "recharge, new front shocks", total_cost: 650, vehicle_id: 14)
Appointment.create(type: "Filter, Air Condition", description: "Drain, flush, refill, new cabin filter", total_cost: 150, vehicle_id: 17)
