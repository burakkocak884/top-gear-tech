...
# Garage.create(name: "Master Tech", location: "Alpharetta, GA",  tire_service: false, service_any_vehicle: true, user_id: 19)
# Garage.create(name: "Speed Tire", location: "Duluth, GA", tire_service: true, service_any_vehicle: true, user_id: 19)
#Garage.destroy_all



#customers table [first_name, last_name, email, gender, vehicles]
# Customer.create(first_name: "Rose", last_name: "Benson",email: "rosedesigner@yahoo.com", standing_balance: 100, garage_id: 3)
# Customer.create(first_name: "Ali", last_name: "Park",email: "Apark@gmail.com", standing_balance: 0, garage_id: 3)
# Customer.create(first_name: "Steve", last_name: "Tall",email: "stall@yahoo.com", standing_balance: 0,garage_id: 3)
# Customer.create(first_name: "Allison", last_name: "Zricvh",email: "azrc@hotmail.com",standing_balance: 200, garage_id: 3)
# Customer.create(first_name: "Jim", last_name: "Carter",email: "JC125@yahoo.com",  standing_balance: 70,garage_id: 3)
# Customer.create(first_name: "Donald", last_name: "Duck",email: "dd456@aol.com",  standing_balance: 0,garage_id: 3)
# Customer.create(first_name: "Mark", last_name: "Kimb",email: "mkb99@gmail.com",  standing_balance: 0,garage_id: 3)
# Customer.create(first_name: "Jason", last_name: "Mason",email: "jmason@gmail.com", standing_balance: 50, garage_id: 3)
# Customer.create(first_name: "Joel", last_name: "Timber",email: "timberj@aol.com",standing_balance: 0,garage_id: 3)
# Customer.create(first_name: "Beth", last_name: "Bethany",email: "bbfashion@att.com", standing_balance: 0, garage_id: 3)
# Customer.create(first_name: "Olli",  last_name: "Martinez",email: "omtinez@tmobile.com", standing_balance: 0, garage_id: 3)
# Customer.create(first_name: "Mike", last_name: "Miller",email: "mm2019@yahoo.com",standing_balance: 0, garage_id: 3)
# #Customer.destroy_all


# #appointments table [description, date,garage_id, customer_id]
Appointment.create(description: "Tune-up", date: "06/16/2019", garage_id: 3, customer_id: 4, vehicle_id:1)
Appointment.create(description: "Brakes", date: "06/14/2019", garage_id: 3, customer_id: 2, vehicle_id:2)
Appointment.create(description: "A/C not working", date: "06/22/2019", garage_id: 3, customer_id: 3, vehicle_id:3)
Appointment.create(description: "Oil Leak", date: "06/01/2019", garage_id: 3, customer_id: 5, vehicle_id:4)
Appointment.create(description: "Oil Change", date: "06/04/2019", garage_id: 3, customer_id: 7, vehicle_id:5)
Appointment.create(description: "Driver side CV-axel", date: "06/10/2019", garage_id: 3, customer_id: 4, vehicle_id:6)
Appointment.create(description: "Power Steering", date: "06/23/2019", garage_id: 3, customer_id: 6, vehicle_id:7)
Appointment.create(description: "Fuel system check", date: "06/10/2019", garage_id: 3, customer_id: 8, vehicle_id:8)
Appointment.create(description: "Emissions test", date: "06/22/2019", garage_id: 3, customer_id: 9, vehicle_id:9)
Appointment.create(description: "60k miles tune-up", date: "06/13/2019", garage_id: 3, customer_id: 3, vehicle_id:10)
Appointment.create(description: "Shocks", date: "06/07/2019", garage_id: 3, customer_id: 1, vehicle_id:11)
